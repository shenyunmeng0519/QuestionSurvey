...
import com.anywide.welife.account.AccountBean;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    //chenwei added to 20180125
    private TableEntity accoutTableEntity = new TableEntity(TABLE_ACCOUNT);
    ...
    public DBHelper(Context context) {
        ...
        //chenwei added to 20180125
        String[] key = {AccountBean.COLUMN_DOMAIN, AccountBean.COLUMN_USERID, AccountBean.COLUMN_COOKIENAME};
        accoutTableEntity.addColumn(new ColumnEntity(AccountBean.COLUMN_DOMAIN, "VARCHAR"))
                .addColumn(new ColumnEntity(AccountBean.COLUMN_USERID, "INTEGER"))
                .addColumn(new ColumnEntity(AccountBean.COLUMN_COOKIENAME, "VARCHAR"))
                .addColumn(new ColumnEntity(AccountBean.COLUMN_NICKNAME, "VARCHAR"))
                .addColumn(new ColumnEntity(AccountBean.COLUMN_ADDTIME, "INTEGER"))
                .addColumn(new ColumnEntity(AccountBean.COLUMN_COOKIE, "BLOB"))
                .addColumn(new ColumnEntity(AccountBean.COLUMN_USERHEADPATH, "VARCHAR"))
                .addColumn(new ColumnEntity(key));
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //chenwei added to 20180125
        db.execSQL(accoutTableEntity.buildTableString());
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        //chenwei added to 20180125
        if (DBUtils.isNeedUpgradeTable(db, accoutTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_ACCOUNT);
        onCreate(db);
    }
