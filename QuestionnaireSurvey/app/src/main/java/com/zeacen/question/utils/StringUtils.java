...
public class StringUtils {
    ...
    /**
     * 有金币的场合，替换幸运币
     * <p>Title: replaceGold</p>
     *
     * @return
     * @author cw
     * @date 2016年6月16日 上午9:20:33
     */
    public static void replaceGold(TextView tv, int res) {
        tv.setText(replaceGold(AppApplication.getApp().getResources().getText(res).toString()));
    }

    public static void replaceGoldHint(TextView tv, int res) {
        tv.setHint(replaceGold(AppApplication.getApp().getResources().getText(res).toString()));
    }

    public static String replaceGold(String str) {
        return str.replace("金币", "鲜花");
    }

    public static String getGoldName() {
        return ConfigUtils.getGoldName();
    }
