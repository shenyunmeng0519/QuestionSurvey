package com.zeacen.question.comm;
...
public class StrokeTextView3 extends TextView {
    ...
    public StrokeTextView3(Context context, int outerColor, int innnerColor) {
        super(context);
    ...
    public StrokeTextView3(Context context, AttributeSet attrs, int defStyle, int outerColor, int innnerColor) {
    ...
    protected void onDraw(Canvas canvas) {
        if (m_bDrawSideLine) {
            ...
            m_TextPaint.setStrokeWidth(0.5f); // 描边宽度
