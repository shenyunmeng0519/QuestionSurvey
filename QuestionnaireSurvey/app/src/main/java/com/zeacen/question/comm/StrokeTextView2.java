...
public class StrokeTextView2 extends TextView {
    ...
    public StrokeTextView2(Context context, int outerColor, int innnerColor) {
        super(context);
    ...
    public StrokeTextView2(Context context, AttributeSet attrs, int defStyle, int outerColor, int innnerColor) {
